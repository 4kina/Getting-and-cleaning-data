setwd("/Users/anastasia/Documents/Coursera/Getting and Cleaning Data/week4/UCI HAR Dataset")
## step 1
# read all the data
...
# put it together in the format of: subjects, activity, everything else
